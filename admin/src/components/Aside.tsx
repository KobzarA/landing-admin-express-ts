...
function getNavlinkclasses({
  ...
  return isPending
    ? "text-cyan-300 flex space-x-2"
    : isActive
    ? "text-cyan-500 flex space-x-2"
    : " hover:text-cyan-300 flex space-x-2";
}
const Aside = () => {
  return (
    <aside className="row-span-2  min-h-screen  border-r border-zinc-700 ">
      {/* inner */}
      <div className="sticky left-0 top-0  p-2 pt-5 ">
